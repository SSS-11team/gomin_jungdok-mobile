...
part of 'todayWorry_repository.dart';
...
class _TodayWorryRepository implements TodayWorryRepository {
  _TodayWorryRepository(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'http://34.64.52.253:3030/api/post/today';
  }
  ...
  Future<TodayWorryDetails> fetchTodayWorryDetailsPosts({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TodayWorryDetails>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/${id}',
    ...
    late TodayWorryDetails _value;
    try {
      _value = TodayWorryDetails.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<ApiResponse<CommentListResponse>> fetchComment({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<CommentListResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/${id}/comment',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<CommentListResponse> _value;
    try {
      _value = ApiResponse<CommentListResponse>.fromJson(
        _result.data!,
        (json) => CommentListResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<ApiResponse<dynamic>> registerComment({
    required int id,
